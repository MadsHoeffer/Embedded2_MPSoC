; ModuleID = '/home/mads/EmbeddedAssignment2/Embedded2_MPSoC/hls/KF_kernel/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_KalmanFilterKernel_ir(float* %din, float* %dout, float %q, float %r, %struct.ap_uint* nocapture readonly %countin) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_KalmanFilterKernel_hw(float* %2, float* %3, float %q, float %r, %struct.ap_uint* %countin)
...
declare void @apatb_KalmanFilterKernel_hw(float*, float*, float, float, %struct.ap_uint*)

define void @KalmanFilterKernel_hw_stub_wrapper(float*, float*, float, float, %struct.ap_uint*) #5 {
entry:
  ...
  call void @KalmanFilterKernel_hw_stub(float* %7, float* %8, float %2, float %3, %struct.ap_uint* %4)
  call void @copy_in([6 x float]* null, [6 x float]* %5, [6 x float]* null, [6 x float]* %6)
  ret void
}

declare void @KalmanFilterKernel_hw_stub(float*, float*, float, float, %struct.ap_uint*)
