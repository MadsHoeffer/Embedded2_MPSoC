...
entity KalmanFilterKernel_B_ram is 
    generic(
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 5; 
            MEM_SIZE    : integer := 18
...
architecture rtl of KalmanFilterKernel_B_ram is 
...
architecture arch of KalmanFilterKernel_B is
    component KalmanFilterKernel_B_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    KalmanFilterKernel_B_ram_U :  component KalmanFilterKernel_B_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
